 ...
 */
    ...
    hasColConflictAt: function(colIndex) {
      var counter = 0;
      for (var i = 0; i < this.rows()[colIndex].length; i++) {
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      var counter = 0;
      for (var i = 0; i < this.rows().length; i++) {
        if (this._isInBounds(i, i + majorDiagonalColumnIndexAtFirstRow)) {
          counter += this.rows()[i][i + majorDiagonalColumnIndexAtFirstRow];
        }
        if (counter > 1) {
          return true;
        }
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      for (var i = 0; i < this.rows().length; i++) {
        if (this._isInBounds(i, minorDiagonalColumnIndexAtFirstRow - i)) {
          counter += this.rows()[i][minorDiagonalColumnIndexAtFirstRow - i];
        }
        if (counter > 1) {
          return true;
        }
